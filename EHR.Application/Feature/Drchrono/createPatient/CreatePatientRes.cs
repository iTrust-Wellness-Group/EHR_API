...
namespace EHR.Application.Feature.Drchrono.createPatient
{
    public class CreatePatientRes
    {
        ...
        public object[] custom_demographics { get; set; }
        ...
        public object[] patient_flags { get; set; }
        public object[] patient_flags_attached { get; set; }
        public Referring_Doctor referring_doctor { get; set; }
        public string referring_source { get; set; }
        public string copay { get; set; }
        public Primary_Insurance primary_insurance { get; set; }
        public Secondary_Insurance secondary_insurance { get; set; }
        public Tertiary_Insurance tertiary_insurance { get; set; }
        public Auto_Accident_Insurance auto_accident_insurance { get; set; }
        public Workers_Comp_Insurance workers_comp_insurance { get; set; }
        ...
        public class Primary_Insurance
        {
        ...
        public class Tertiary_Insurance
        {
            public string insurance_company { get; set; }
            public string insurance_id_number { get; set; }
            public string insurance_group_name { get; set; }
        ...
        public class Auto_Accident_Insurance
        {
        ...
        public class Workers_Comp_Insurance
        {
